...
${OBJECTDIR}/Tachometer.o: Tachometer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DUBRR0H -DUBRR1H -DUBRR2H -DUBRR3H -DARDUINO_ARCH_AVR -I../core -I../core/core -I../libraries/LiquidCrystal -I../libraries/Servo -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tachometer.o Tachometer.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DUBRR0H -DUBRR1H -DUBRR2H -DUBRR3H -DARDUINO_ARCH_AVR -I../core -I../core/core -I../libraries/LiquidCrystal -I../libraries/Servo -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
