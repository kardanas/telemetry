...
LDLIBSOPTIONS=-L../core/dist/Release ../libraries/dist/Release/libraries.a ../core/dist/Release/core.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/telemetry.exe

${CND_DISTDIR}/${CND_CONF}/telemetry.exe: ../libraries/dist/Release/libraries.a

${CND_DISTDIR}/${CND_CONF}/telemetry.exe: ../core/dist/Release/core.a
...
${OBJECTDIR}/Tachometer.o: Tachometer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DARDUINO_ARCH_AVR -DUBRR0H -DUBRR1H -DUBRR2H -DUBRR3H -I../core -I../core/core -I../libraries/LiquidCrystal -I../libraries/Servo -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tachometer.o Tachometer.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DARDUINO_ARCH_AVR -DUBRR0H -DUBRR1H -DUBRR2H -DUBRR3H -I../core -I../core/core -I../libraries/LiquidCrystal -I../libraries/Servo -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp

# Subprojects
.build-subprojects:
	cd ../libraries && ${MAKE}  -f Makefile CONF=Release
...
# Subprojects
.clean-subprojects:
	cd ../libraries && ${MAKE}  -f Makefile CONF=Release clean
